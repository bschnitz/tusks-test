    ...
    pub mod __tusks_internal_module {
                ...
                let mut node = tusks::TusksNode {
                    ...
                    tusks: <[_]>::into_vec(
                        ::alloc::boxed::box_new([
                            ...
                            tusks::Tusk {
                                name: "t_multiple_vec".to_string(),
                                arguments: {
                                    let mut map = tusks::indexmap::IndexMap::new();
                                    map.insert(
                                        "v_vec".to_string(),
                                        tusks::Argument {
                                            name: "v_vec".to_string(),
                                            type_: "String".to_string(),
                                            default: None,
                                            optional: false,
                                            flag: false,
                            ...
                            tusks::Tusk {
                                name: "t_multiple_vec_int".to_string(),
                                arguments: {
                                    let mut map = tusks::indexmap::IndexMap::new();
                                    map.insert(
                                        "v_vec".to_string(),
                            ...
                            tusks::Tusk {
                                name: "t_multiple_min_max".to_string(),
                                arguments: {
                                    let mut map = tusks::indexmap::IndexMap::new();
                                    map.insert(
                                        "v_vec".to_string(),
                            ...
                            tusks::Tusk {
                                name: "t_string_defaults".to_string(),
                                arguments: {
                                    let mut map = tusks::indexmap::IndexMap::new();
                                    map.insert(
                                        "v_default".to_string(),
                                        tusks::Argument {
                                            name: "v_default".to_string(),
                                            type_: "String".to_string(),
        ...
        pub fn build_cli(
            ...
            let subcommand = {
                let cmd_name = {
                    let mut parts = path_prefix.clone();
                    parts.push("t_multiple_vec".to_string());
                    parts.join(".")
                };
                let mut cmd = clap::Command::new(cmd_name);
                cmd = cmd
            ...
            let subcommand = {
                let cmd_name = {
                    let mut parts = path_prefix.clone();
                    parts.push("t_multiple_vec_int".to_string());
                    parts.join(".")
                };
                let mut cmd = clap::Command::new(cmd_name);
                cmd = cmd
            ...
            let subcommand = {
                let cmd_name = {
                    let mut parts = path_prefix.clone();
                    parts.push("t_multiple_min_max".to_string());
                    parts.join(".")
                };
                let mut cmd = clap::Command::new(cmd_name);
                cmd = cmd
            ...
            let subcommand = {
                let cmd_name = {
                    let mut parts = path_prefix.clone();
                    parts.push("t_optional_vec".to_string());
                    parts.join(".")
                };
                let mut cmd = clap::Command::new(cmd_name);
                cmd = cmd
            ...
            let subcommand = {
                let cmd_name = {
                    let mut parts = path_prefix.clone();
                    parts.push("t_string_defaults".to_string());
                    parts.join(".")
                };
                let mut cmd = clap::Command::new(cmd_name);
                cmd = cmd
                    .arg(
                        clap::Arg::new("v_default")
                            .value_name("V_DEFAULT")
                            .value_parser({
                                use ::clap_builder::builder::impl_prelude::*;
                                let auto = ::clap_builder::builder::_infer_ValueParser_for::<
                                    String,
            ...
            let subcommand = {
                let cmd_name = {
                    let mut parts = path_prefix.clone();
                    parts.push("t_int_defaults".to_string());
                    parts.join(".")
                };
                let mut cmd = clap::Command::new(cmd_name);
                cmd = cmd
            ...
            match actual_command {
                ...
                "t_multiple_vec" => {
                    let arg_0 = matches
                        ...
                        .unwrap()
                        .1
                        .get_many::<String>("v_vec")
                        .unwrap()
                        .cloned()
                        .collect::<Vec<_>>()
                        .into();
                    super::t_multiple_vec(arg_0);
                    return true;
                }
                "t_multiple_vec_int" => {
                    let arg_0 = matches
                        ...
                        .collect::<Vec<_>>()
                        .into();
                    super::t_multiple_vec_int(arg_0);
                    return true;
                }
                "t_multiple_min_max" => {
                    let arg_0 = matches
                        ...
                        .collect::<Vec<_>>()
                        .into();
                    super::t_multiple_min_max(arg_0);
                    return true;
                }
                "t_optional_vec" => {
                    let arg_0 = matches
                        ...
                        .1
                        .get_many::<String>("v_vec")
                        .map(|v| v.cloned().collect::<Vec<_>>().into());
                    super::t_optional_vec(arg_0);
                    return true;
                }
                "t_string_defaults" => {
                    let arg_0 = matches
                        ...
                        .unwrap()
                        .1
                        .get_one::<String>("v_default")
                        .map(|v| v.clone())
                        .unwrap_or_else(|| "default".to_string());
                    super::t_string_defaults(arg_0);
                    return true;
                }
                "t_int_defaults" => {
                    let arg_0 = matches
                        ...
                        .unwrap()
                        .1
                        .get_one::<u8>("v_default")
                        .map(|v| v.clone())
                        .unwrap_or_else(|| "23".to_string());
                    super::t_int_defaults(arg_0);
                    return true;
                }
                "docker.build" => {
                    let arg_0 = matches
